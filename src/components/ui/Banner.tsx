...
const STYLES: Record<Variant, { box: string; icon: string; Icon: typeof Info }> = {
  ...
  success: { box: "border-green-500/40 bg-green-500/10", icon: "text-green-500", Icon: CheckCircle2 },
  warning: { box: "border-yellow-500/40 bg-yellow-500/10", icon: "text-yellow-500", Icon: TriangleAlert },
};
