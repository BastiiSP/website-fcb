 ...
 *
 * Layering (z-Index):
 *   HybridCanvas  (z-0, pointer-events:none via Style)
 *   HybridPitch   (z-0, pointer-events:none, liegt im DOM nach Canvas → sichtbar darüber)
 *   Vignette      (z-0, Lesbarkeits-Gradient)
 *   Content       (z-10)
 */
