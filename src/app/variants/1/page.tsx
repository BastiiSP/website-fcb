...
import NexusCanvas from "./_components/NexusCanvas";

/**
 * Variante 1 – Nexus
 *
 * Interaktives Dot-Grid als Hero-Hintergrund, das auf die Maus reagiert
 * (Punkte weichen aus). Wappen zentriert mit blauem Radial-Glow.
 * Headlines erscheinen mit vertikalem Stagger von unten.
 */
...
export default function VariantOnePage() {
  return (
    <section className="relative min-h-[calc(100vh-6rem)] overflow-hidden">
      {/* Interaktiver Dot-Grid Hintergrund */}
      <NexusCanvas />

      {/* Sanfter Vignette-Gradient damit Text gut lesbar bleibt */}
      <div
        aria-hidden
      ...
      <div className="relative z-10 mx-auto flex max-w-5xl flex-col items-center px-4 pt-16 pb-24 text-center">
        ...
        {/* Headline: jede Zeile separat von unten eingeblendet */}
        <h1 className="font-oswald font-bold uppercase leading-[0.95] tracking-tight text-white">
          {HEADLINE_LINES.map((line, i) => (
            <motion.span
              ...
              style={{
                // Letzte Zeile in FCB-Blau – verleiht der Stadt das Gewicht.
        ...
        <motion.p
          ...
          className="mt-6 font-inter text-sm uppercase tracking-[0.4em] text-white/70"
        >
          Tradition seit 1911
        </motion.p>
