...
6. **AGENTS.md** aktualisieren: Tabelle im Abschnitt „Datenbankschema" + neue Dateipfade ergänzen.
...
| AGENTS.md nicht aktualisiert | Schema-Doku driftet. Schritt 6 ist Teil der Aufgabe. |
